...
XGBOOST_SEARCH_ITER = 20
RANDOM_FOREST_SEARCH_ITER = 25

FINAL_TUNING_CANDIDATES = [
    {
        "candidate_name": "elastic_net_fe_core_smote_ref",
        "feature_set": "fe_core",
    ...
    {
        "candidate_name": "xgboost_raw_baseline_smote_ref",
    ...
    {
        "candidate_name": "xgboost_fe_silent_attrition_v1_smote",
        "feature_set": "fe_silent_attrition_v1",
        "model_key": "xgboost",
        "family": "boosting",
        "sampling_method": "smote",
    ...
    {
        "candidate_name": "random_forest_raw_baseline_borderline_ref",
        "feature_set": "raw_baseline",
    ...
    {
        "candidate_name": "random_forest_fe_silent_attrition_v1_borderline",
        "feature_set": "fe_silent_attrition_v1",
        "model_key": "random_forest",
        "family": "tree_ensemble",
        "sampling_method": "borderline",
...
def export_results(
    ...
    file_name = f"{pd.Timestamp.now().strftime('%y%m%d')}-final_tuning_newfe.xlsx"
