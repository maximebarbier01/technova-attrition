...
def main() -> None:
    ...
    output_path = PROJECT_ROOT / "models" / "final_model.joblib"

    artifact = {
        "model": trained_model,
        "threshold": float(final_model_config["threshold"]),
        "feature_set_name": prepared["feature_set_name"],
        "num_features": prepared["num_features"],
        "cat_features": prepared["cat_features"],
        "feature_columns": prepared["num_features"] + prepared["cat_features"],
        "target": feature_config["target"],
        "model_key": final_model_config["model_key"],
        "display_name": final_model_config["display_name"],
        "sampling_method": final_model_config["sampling_method"],
    }
